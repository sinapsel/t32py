...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "/home/mark/anaconda3/lib/python3.9/site-packages/numpy/core/include/numpy/arrayobject.h",
            "/home/mark/anaconda3/lib/python3.9/site-packages/numpy/core/include/numpy/arrayscalars.h",
            "/home/mark/anaconda3/lib/python3.9/site-packages/numpy/core/include/numpy/ndarrayobject.h",
            "/home/mark/anaconda3/lib/python3.9/site-packages/numpy/core/include/numpy/ndarraytypes.h",
            "/home/mark/anaconda3/lib/python3.9/site-packages/numpy/core/include/numpy/ufuncobject.h"
        ],
        "extra_compile_args": [
            "-fopenmp",
            "-O3"
        ...
        "include_dirs": [
            "/home/mark/anaconda3/lib/python3.9/site-packages/numpy/core/include"
        ],
        "name": "boris_method",
        "sources": [
            "boris_method.pyx"
...
#define __PYX_HAVE__boris_method
#define __PYX_HAVE_API__boris_method
/* Early includes */
#include <string.h>
#include <stdio.h>
...
struct __pyx_obj_3emf_EMF {
  PyObject_HEAD
  struct __pyx_vtabstruct_3emf_EMF *__pyx_vtab;
  int parameter;
  double frequency;
  double magnitude;
  double phase;
  double k[3];
  __Pyx_memviewslice k_mv;
};
...
struct __pyx_obj_8particle_Particle {
  ...
  double q;
  double m;
  __Pyx_memviewslice x0;
  __Pyx_memviewslice p0;
};
...
struct __pyx_vtabstruct_3emf_EMF {
  double (*e)(struct __pyx_obj_3emf_EMF *, __Pyx_memviewslice, double, int);
  double (*h)(struct __pyx_obj_3emf_EMF *, __Pyx_memviewslice, double, int);
};
static struct __pyx_vtabstruct_3emf_EMF *__pyx_vtabptr_3emf_EMF;
...
static double (*__pyx_f_5maths_dot_product)(__Pyx_memviewslice, __Pyx_memviewslice); /*proto*/
static double (*__pyx_f_5maths_cross_i)(__Pyx_memviewslice, __Pyx_memviewslice, int); /*proto*/

/* Module declarations from 'emf' */
static PyTypeObject *__pyx_ptype_3emf_EMF = 0;

/* Module declarations from 'particle' */
static PyTypeObject *__pyx_ptype_8particle_Particle = 0;

/* Module declarations from 'boris_method' */
...
static PyObject *__pyx_f_12boris_method_boris_push(struct __pyx_obj_8particle_Particle *, struct __pyx_obj_3emf_EMF *, PyObject *, PyObject *, PyObject *, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "boris_method"
extern int __pyx_module_is_main_boris_method;
int __pyx_module_is_main_boris_method = 0;

/* Implementation of 'boris_method' */
...
static const char __pyx_k_ptcl[] = "ptcl";
...
static const char __pyx_k_react[] = "react";
...
static PyObject *__pyx_n_s_ptcl;
...
static PyObject *__pyx_n_s_t_span;
...
static PyObject *__pyx_pf_12boris_method_boris_push(CYTHON_UNUSED PyObject *__pyx_self, struct __pyx_obj_8particle_Particle *__pyx_v_ptcl, struct __pyx_obj_3emf_EMF *__pyx_v_field, PyObject *__pyx_v_t_span, PyObject *__pyx_v_nt, PyObject *__pyx_v_react); /* proto */
...
static PyObject *__pyx_pw_12boris_method_1boris_push(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_12boris_method_boris_push(struct __pyx_obj_8particle_Particle *__pyx_v_ptcl, struct __pyx_obj_3emf_EMF *__pyx_v_field, PyObject *__pyx_v_t_span, PyObject *__pyx_v_nt, PyObject *__pyx_v_react, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_k;
  int __pyx_v_swtch;
  int __pyx_v_stp;
  ...
  double __pyx_v_dt;
  double __pyx_v_temp;
  double __pyx_v_p_plus[3];
  double __pyx_v_p_minus[3];
  double __pyx_v_p_prime[3];
  double __pyx_v_tau[3];
  double __pyx_v_sigma[3];
  double __pyx_v_averV[3];
  double __pyx_v_currE[3];
  double __pyx_v_currH[3];
  __Pyx_memviewslice __pyx_v_t_mv = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_x_mv = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_p_mv = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_v_mv = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_p_minus_mv = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_p_prime_mv = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_tau_mv = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_sigma_mv = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_averV_mv = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_currE_mv = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_currH_mv = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("boris_push", 0);
 ...
 */
  ...
  if (PyFunction_Check(__pyx_t_3)) {
    PyObject *__pyx_temp[4] = {__pyx_t_2, PyTuple_GET_ITEM(__pyx_v_t_span, 0), PyTuple_GET_ITEM(__pyx_v_t_span, 1), __pyx_v_nt};
  ...
  #endif
  {
    ...
    __Pyx_INCREF(PyTuple_GET_ITEM(__pyx_v_t_span, 0));
    __Pyx_GIVEREF(PyTuple_GET_ITEM(__pyx_v_t_span, 0));
    PyTuple_SET_ITEM(__pyx_t_5, 0+__pyx_t_4, PyTuple_GET_ITEM(__pyx_v_t_span, 0));
    __Pyx_INCREF(PyTuple_GET_ITEM(__pyx_v_t_span, 1));
    __Pyx_GIVEREF(PyTuple_GET_ITEM(__pyx_v_t_span, 1));
    PyTuple_SET_ITEM(__pyx_t_5, 1+__pyx_t_4, PyTuple_GET_ITEM(__pyx_v_t_span, 1));
    __Pyx_INCREF(__pyx_v_nt);
    __Pyx_GIVEREF(__pyx_v_nt);
    PyTuple_SET_ITEM(__pyx_t_5, 2+__pyx_t_4, __pyx_v_nt);
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_double); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_dtype, __pyx_t_6) < 0) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_5, __pyx_t_1); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_zeros); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 46, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_double); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 46, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_t_6, __pyx_n_s_dtype, __pyx_t_2) < 0) __PYX_ERR(0, 46, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_5, __pyx_t_6); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 46, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_zeros); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 47, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __Pyx_INCREF(__pyx_v_nt);
  __Pyx_GIVEREF(__pyx_v_nt);
  PyTuple_SET_ITEM(__pyx_t_2, 0, __pyx_v_nt);
  __Pyx_INCREF(__pyx_int_3);
  __Pyx_GIVEREF(__pyx_int_3);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_double); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 47, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_dtype, __pyx_t_3) < 0) __PYX_ERR(0, 47, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_6, __pyx_t_5, __pyx_t_2); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 47, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 * 
 */
  __pyx_t_4 = __Pyx_PyInt_As_int(__pyx_v_react); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 48, __pyx_L1_error)
  __pyx_v_swtch = __pyx_t_4;
 ...
 * 
 */
  __pyx_t_4 = __Pyx_PyInt_As_int(__pyx_v_nt); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 49, __pyx_L1_error)
 ...
 *     p_mv = p
 */
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_v_t, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 52, __pyx_L1_error)
  __pyx_v_t_mv = __pyx_t_7;
 ...
 *     v_mv = v
 */
  __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_v_x, PyBUF_WRITABLE); if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 53, __pyx_L1_error)
  __pyx_v_x_mv = __pyx_t_8;
 ...
 * 
 */
  __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_v_p, PyBUF_WRITABLE); if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 54, __pyx_L1_error)
  __pyx_v_p_mv = __pyx_t_8;
  __pyx_t_8.memview = NULL;
  __pyx_t_8.data = NULL;
 ...
 *     dt = t[1] - t[0]
 */
  __pyx_t_8 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(__pyx_v_v, PyBUF_WRITABLE); if (unlikely(!__pyx_t_8.memview)) __PYX_ERR(0, 55, __pyx_L1_error)
  __pyx_v_v_mv = __pyx_t_8;
  __pyx_t_8.memview = NULL;
  __pyx_t_8.data = NULL;
 ...
 *     K = 0
 */
  __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_t, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_GetItemInt(__pyx_v_t, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_5 = PyNumber_Subtract(__pyx_t_3, __pyx_t_2); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_9 = __pyx_PyFloat_AsDouble(__pyx_t_5); if (unlikely((__pyx_t_9 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 57, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 * 
 */
  __pyx_v_scaling = ((__pyx_v_field->frequency * pow(__pyx_v_ptcl->q, 2.0)) / __pyx_v_ptcl->m);
 ...
 *     for k in range(3):
 */
  __pyx_t_5 = __pyx_memoryview_fromslice(__pyx_v_ptcl->x0, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 61, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  if (unlikely(PyObject_SetItem(__pyx_v_x, __pyx_tuple__2, __pyx_t_5) < 0)) __PYX_ERR(0, 61, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
  __pyx_t_5 = __pyx_memoryview_fromslice(__pyx_v_ptcl->p0, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 62, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  if (unlikely(PyObject_SetItem(__pyx_v_p, __pyx_tuple__2, __pyx_t_5) < 0)) __PYX_ERR(0, 62, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
    ...
    __pyx_t_5 = __Pyx_PyObject_GetItem(__pyx_v_p, __pyx_tuple__2); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 64, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 64, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_5 = __Pyx_PyObject_GetItem(__pyx_v_p, __pyx_tuple__2); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 64, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_11 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_11.memview)) __PYX_ERR(0, 64, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_5 = PyFloat_FromDouble(((*((double *) ( /* dim=0 */ (__pyx_v_ptcl->p0.data + __pyx_t_10 * __pyx_v_ptcl->p0.strides[0]) ))) / sqrt((1.0 + __pyx_f_5maths_dot_product(__pyx_t_7, __pyx_t_11))))); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 64, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    ...
    __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_k); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 64, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    ...
    __pyx_t_2 = 0;
    if (unlikely(PyObject_SetItem(__pyx_v_v, __pyx_t_3, __pyx_t_5) < 0)) __PYX_ERR(0, 64, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  }
 ...
 *     tau_mv = tau
 */
  __pyx_t_3 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_double); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 66, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)3)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 66, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_12 = __pyx_array_new(__pyx_t_5, sizeof(double), PyBytes_AS_STRING(__pyx_t_3), (char *) "fortran", (char *) __pyx_v_p_minus);
  if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 66, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_11 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(((PyObject *)__pyx_t_12), PyBUF_WRITABLE); if (unlikely(!__pyx_t_11.memview)) __PYX_ERR(0, 66, __pyx_L1_error)
  __Pyx_DECREF(((PyObject *)__pyx_t_12)); __pyx_t_12 = 0;
  __pyx_v_p_minus_mv = __pyx_t_11;
  __pyx_t_11.memview = NULL;
  __pyx_t_11.data = NULL;
 ...
 *     sigma_mv = sigma
 */
  __pyx_t_5 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_double); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_3 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)3)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_12 = __pyx_array_new(__pyx_t_3, sizeof(double), PyBytes_AS_STRING(__pyx_t_5), (char *) "fortran", (char *) __pyx_v_p_prime);
  if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_11 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(((PyObject *)__pyx_t_12), PyBUF_WRITABLE); if (unlikely(!__pyx_t_11.memview)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_DECREF(((PyObject *)__pyx_t_12)); __pyx_t_12 = 0;
  __pyx_v_p_prime_mv = __pyx_t_11;
  __pyx_t_11.memview = NULL;
  __pyx_t_11.data = NULL;
 ...
 *     averV_mv = averV
 */
  __pyx_t_3 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_double); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)3)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_12 = __pyx_array_new(__pyx_t_5, sizeof(double), PyBytes_AS_STRING(__pyx_t_3), (char *) "fortran", (char *) __pyx_v_tau);
  if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_11 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(((PyObject *)__pyx_t_12), PyBUF_WRITABLE); if (unlikely(!__pyx_t_11.memview)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_DECREF(((PyObject *)__pyx_t_12)); __pyx_t_12 = 0;
  __pyx_v_tau_mv = __pyx_t_11;
  __pyx_t_11.memview = NULL;
  __pyx_t_11.data = NULL;
 ...
 *     currE_mv = currE
 */
  __pyx_t_5 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_double); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_3 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)3)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_12 = __pyx_array_new(__pyx_t_3, sizeof(double), PyBytes_AS_STRING(__pyx_t_5), (char *) "fortran", (char *) __pyx_v_sigma);
  if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_11 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(((PyObject *)__pyx_t_12), PyBUF_WRITABLE); if (unlikely(!__pyx_t_11.memview)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_DECREF(((PyObject *)__pyx_t_12)); __pyx_t_12 = 0;
  __pyx_v_sigma_mv = __pyx_t_11;
  __pyx_t_11.memview = NULL;
  __pyx_t_11.data = NULL;
 ...
 *     currH_mv = currH
 */
  __pyx_t_3 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_double); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)3)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_12 = __pyx_array_new(__pyx_t_5, sizeof(double), PyBytes_AS_STRING(__pyx_t_3), (char *) "fortran", (char *) __pyx_v_averV);
  if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_11 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(((PyObject *)__pyx_t_12), PyBUF_WRITABLE); if (unlikely(!__pyx_t_11.memview)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_DECREF(((PyObject *)__pyx_t_12)); __pyx_t_12 = 0;
  __pyx_v_averV_mv = __pyx_t_11;
  __pyx_t_11.memview = NULL;
  __pyx_t_11.data = NULL;
 ...
 * 
 */
  __pyx_t_5 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_double); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_3 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)3)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_12 = __pyx_array_new(__pyx_t_3, sizeof(double), PyBytes_AS_STRING(__pyx_t_5), (char *) "fortran", (char *) __pyx_v_currE);
  if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_11 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(((PyObject *)__pyx_t_12), PyBUF_WRITABLE); if (unlikely(!__pyx_t_11.memview)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_DECREF(((PyObject *)__pyx_t_12)); __pyx_t_12 = 0;
  __pyx_v_currE_mv = __pyx_t_11;
  __pyx_t_11.memview = NULL;
  __pyx_t_11.data = NULL;
 ...
 *     with nogil:
 */
  __pyx_t_3 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_double); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)3)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_12 = __pyx_array_new(__pyx_t_5, sizeof(double), PyBytes_AS_STRING(__pyx_t_3), (char *) "fortran", (char *) __pyx_v_currH);
  if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_11 = __Pyx_PyObject_to_MemoryviewSlice_ds_double(((PyObject *)__pyx_t_12), PyBUF_WRITABLE); if (unlikely(!__pyx_t_11.memview)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_DECREF(((PyObject *)__pyx_t_12)); __pyx_t_12 = 0;
  __pyx_v_currH_mv = __pyx_t_11;
  __pyx_t_11.memview = NULL;
  __pyx_t_11.data = NULL;
 ...
 * 
 */
            __pyx_t_11.data = __pyx_v_x_mv.data;
            __pyx_t_11.memview = __pyx_v_x_mv.memview;
            __PYX_INC_MEMVIEW(&__pyx_t_11, 0);
            {
    Py_ssize_t __pyx_tmp_idx = (__pyx_v_i - 1);
    Py_ssize_t __pyx_tmp_stride = __pyx_v_x_mv.strides[0];
        __pyx_t_11.data += __pyx_tmp_idx * __pyx_tmp_stride;
}

__pyx_t_11.shape[0] = __pyx_v_x_mv.shape[1];
__pyx_t_11.strides[0] = __pyx_v_x_mv.strides[1];
    __pyx_t_11.suboffsets[0] = -1;

__pyx_t_10 = __pyx_v_i;
            __pyx_t_16 = __pyx_v_k;
            *((double *) ( /* dim=0 */ (__pyx_v_currE_mv.data + __pyx_t_16 * __pyx_v_currE_mv.strides[0]) )) = ((struct __pyx_vtabstruct_3emf_EMF *)__pyx_v_field->__pyx_vtab)->e(__pyx_v_field, __pyx_t_11, (*((double *) ( /* dim=0 */ (__pyx_v_t_mv.data + __pyx_t_10 * __pyx_v_t_mv.strides[0]) ))), __pyx_v_k);
...
__pyx_t_10 = __pyx_v_i;
            __pyx_t_16 = __pyx_v_k;
            *((double *) ( /* dim=0 */ (__pyx_v_currH_mv.data + __pyx_t_16 * __pyx_v_currH_mv.strides[0]) )) = ((struct __pyx_vtabstruct_3emf_EMF *)__pyx_v_field->__pyx_vtab)->h(__pyx_v_field, __pyx_t_11, (*((double *) ( /* dim=0 */ (__pyx_v_t_mv.data + __pyx_t_10 * __pyx_v_t_mv.strides[0]) ))), __pyx_v_k);
            __PYX_XDEC_MEMVIEW(&__pyx_t_11, 0);
            __pyx_t_11.memview = NULL;
            __pyx_t_11.data = NULL;
          }
 ...
 */
          __pyx_t_11.data = __pyx_v_p_mv.data;
          __pyx_t_11.memview = __pyx_v_p_mv.memview;
          __PYX_INC_MEMVIEW(&__pyx_t_11, 0);
          {
    Py_ssize_t __pyx_tmp_idx = (__pyx_v_i - 1);
    Py_ssize_t __pyx_tmp_stride = __pyx_v_p_mv.strides[0];
        __pyx_t_11.data += __pyx_tmp_idx * __pyx_tmp_stride;
}

__pyx_t_11.shape[0] = __pyx_v_p_mv.shape[1];
__pyx_t_11.strides[0] = __pyx_v_p_mv.strides[1];
    __pyx_t_11.suboffsets[0] = -1;

__pyx_t_7.data = __pyx_v_p_mv.data;
          __pyx_t_7.memview = __pyx_v_p_mv.memview;
...
__pyx_t_7.shape[0] = __pyx_v_p_mv.shape[1];
__pyx_t_7.strides[0] = __pyx_v_p_mv.strides[1];
    __pyx_t_7.suboffsets[0] = -1;

__pyx_v_temp = __pyx_f_5maths_dot_product(__pyx_t_11, __pyx_t_7);
          __PYX_XDEC_MEMVIEW(&__pyx_t_11, 0);
          __pyx_t_11.memview = NULL;
          __pyx_t_11.data = NULL;
 ...
 */
            (__pyx_v_tau[__pyx_v_k]) = ((((__pyx_v_currH[__pyx_v_k]) * __pyx_v_dt) / 2.0) / sqrt((1.0 + __pyx_v_temp)));
          }
 ...
 */
            (__pyx_v_sigma[__pyx_v_k]) = ((2.0 * (__pyx_v_tau[__pyx_v_k])) / (1.0 + __pyx_f_5maths_dot_product(__pyx_v_tau_mv, __pyx_v_tau_mv)));
          }
 ...
 */
            ...
            __pyx_t_16 = __pyx_v_k;
            (__pyx_v_p_minus[__pyx_v_k]) = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_mv.data + __pyx_t_10 * __pyx_v_p_mv.strides[0]) ) + __pyx_t_16 * __pyx_v_p_mv.strides[1]) ))) + (((__pyx_v_currE[__pyx_v_k]) * __pyx_v_dt) / 2.0));
          }
 ...
 */
            (__pyx_v_p_prime[__pyx_v_k]) = ((__pyx_v_p_minus[__pyx_v_k]) + __pyx_f_5maths_cross_i(__pyx_v_p_minus_mv, __pyx_v_tau_mv, __pyx_v_k));
          }
 ...
 */
            (__pyx_v_p_plus[__pyx_v_k]) = ((__pyx_v_p_minus[__pyx_v_k]) + __pyx_f_5maths_cross_i(__pyx_v_p_prime_mv, __pyx_v_sigma_mv, __pyx_v_k));
          }
 ...
 */
            ...
            __pyx_t_10 = __pyx_v_k;
            *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_mv.data + __pyx_t_16 * __pyx_v_p_mv.strides[0]) ) + __pyx_t_10 * __pyx_v_p_mv.strides[1]) )) = ((__pyx_v_p_plus[__pyx_v_k]) + (((__pyx_v_currE[__pyx_v_k]) * __pyx_v_dt) / 2.0));
          }
 ...
 */
            ...
            (__pyx_v_averV[__pyx_v_k]) = ((((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_mv.data + __pyx_t_10 * __pyx_v_p_mv.strides[0]) ) + __pyx_t_16 * __pyx_v_p_mv.strides[1]) ))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_mv.data + __pyx_t_17 * __pyx_v_p_mv.strides[0]) ) + __pyx_t_18 * __pyx_v_p_mv.strides[1]) )))) / 2.0) / sqrt((1.0 + __pyx_v_temp)));
          }
 ...
 *             for k in range(3):
 */
            (__pyx_v_sigma[__pyx_v_k]) = ((__pyx_v_currE[__pyx_v_k]) + __pyx_f_5maths_cross_i(__pyx_v_averV_mv, __pyx_v_currH_mv, __pyx_v_k));
 ...
 */
            __pyx_v_K = (((((1.0 + __pyx_v_temp) * __pyx_v_swtch) * 1.18e-8) * __pyx_v_scaling) * (__pyx_f_5maths_dot_product(__pyx_v_sigma_mv, __pyx_v_sigma_mv) - pow(__pyx_f_5maths_dot_product(__pyx_v_averV_mv, __pyx_v_sigma_mv), 2.0)));
          }
 ...
 */
            ...
            __pyx_t_16 = __pyx_v_i;
            __pyx_t_10 = __pyx_v_k;
            *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_mv.data + __pyx_t_16 * __pyx_v_p_mv.strides[0]) ) + __pyx_t_10 * __pyx_v_p_mv.strides[1]) )) = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_mv.data + __pyx_t_18 * __pyx_v_p_mv.strides[0]) ) + __pyx_t_17 * __pyx_v_p_mv.strides[1]) ))) - ((__pyx_v_dt * __pyx_v_K) * (__pyx_v_averV[__pyx_v_k])));
          }

          /* "boris_method.pyx":101
 *             for k in range(3):
 *                 p_mv[i, k] = p_mv[i, k] - dt * K * averV[k]
 *             for k in range(3):             # <<<<<<<<<<<<<<
 *                 x_mv[i, k] = x_mv[i-1, k] + p_mv[i, k] * dt / sqrt(1 + temp)
 ...
 */
            ...
            *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_x_mv.data + __pyx_t_19 * __pyx_v_x_mv.strides[0]) ) + __pyx_t_20 * __pyx_v_x_mv.strides[1]) )) = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_x_mv.data + __pyx_t_17 * __pyx_v_x_mv.strides[0]) ) + __pyx_t_18 * __pyx_v_x_mv.strides[1]) ))) + (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_mv.data + __pyx_t_10 * __pyx_v_p_mv.strides[0]) ) + __pyx_t_16 * __pyx_v_p_mv.strides[1]) ))) * __pyx_v_dt) / sqrt((1.0 + __pyx_v_temp))));
          }

          /* "boris_method.pyx":103
 *             for k in range(3):
 *                 x_mv[i, k] = x_mv[i-1, k] + p_mv[i, k] * dt / sqrt(1 + temp)
 *             for k in range(3):             # <<<<<<<<<<<<<<
 *                 v_mv[i, k] = p_mv[i, k] / sqrt(1 + temp)
 ...
 */
            ...
            __pyx_t_18 = __pyx_v_i;
            __pyx_t_17 = __pyx_v_k;
            *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_v_mv.data + __pyx_t_18 * __pyx_v_v_mv.strides[0]) ) + __pyx_t_17 * __pyx_v_v_mv.strides[1]) )) = ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_p_mv.data + __pyx_t_16 * __pyx_v_p_mv.strides[0]) ) + __pyx_t_10 * __pyx_v_p_mv.strides[1]) ))) / sqrt((1.0 + __pyx_v_temp)));
          }
        }
      }
 ...
 */
  ...
  PyTuple_SET_ITEM(__pyx_t_3, 3, __pyx_v_v);
 ...
 */
  ...
  __Pyx_AddTraceback("boris_method.boris_push", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_t_mv, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_x_mv, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_p_mv, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_v_mv, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_p_minus_mv, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_p_prime_mv, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_tau_mv, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_sigma_mv, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_averV_mv, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_currE_mv, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_currH_mv, 1);
...
/* Python wrapper */
static PyObject *__pyx_pw_12boris_method_1boris_push(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_12boris_method_1boris_push(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  struct __pyx_obj_8particle_Particle *__pyx_v_ptcl = 0;
  struct __pyx_obj_3emf_EMF *__pyx_v_field = 0;
  PyObject *__pyx_v_t_span = 0;
  PyObject *__pyx_v_nt = 0;
  PyObject *__pyx_v_react = 0;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("boris_push (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_ptcl,&__pyx_n_s_field,&__pyx_n_s_t_span,&__pyx_n_s_nt,&__pyx_n_s_react,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ptcl)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_field)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("boris_push", 1, 5, 5, 1); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_t_span)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("boris_push", 1, 5, 5, 2); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nt)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("boris_push", 1, 5, 5, 3); __PYX_ERR(0, 10, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_react)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("boris_push", 1, 5, 5, 4); __PYX_ERR(0, 10, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "boris_push") < 0)) __PYX_ERR(0, 10, __pyx_L3_error)
      }
    ...
    __pyx_v_ptcl = ((struct __pyx_obj_8particle_Particle *)values[0]);
    __pyx_v_field = ((struct __pyx_obj_3emf_EMF *)values[1]);
    __pyx_v_t_span = ((PyObject*)values[2]);
    __pyx_v_nt = values[3];
    __pyx_v_react = values[4];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("boris_push", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 10, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("boris_method.boris_push", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_ptcl), __pyx_ptype_8particle_Particle, 1, "ptcl", 0))) __PYX_ERR(0, 10, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_field), __pyx_ptype_3emf_EMF, 1, "field", 0))) __PYX_ERR(0, 10, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_t_span), (&PyTuple_Type), 1, "t_span", 1))) __PYX_ERR(0, 10, __pyx_L1_error)
  __pyx_r = __pyx_pf_12boris_method_boris_push(__pyx_self, __pyx_v_ptcl, __pyx_v_field, __pyx_v_t_span, __pyx_v_nt, __pyx_v_react);
...
static PyObject *__pyx_pf_12boris_method_boris_push(CYTHON_UNUSED PyObject *__pyx_self, struct __pyx_obj_8particle_Particle *__pyx_v_ptcl, struct __pyx_obj_3emf_EMF *__pyx_v_field, PyObject *__pyx_v_t_span, PyObject *__pyx_v_nt, PyObject *__pyx_v_react) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("boris_push", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_12boris_method_boris_push(__pyx_v_ptcl, __pyx_v_field, __pyx_v_t_span, __pyx_v_nt, __pyx_v_react, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "boris_method.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "boris_method._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"boris_push", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_12boris_method_1boris_push, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_boris_method(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_boris_method},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_ptcl, __pyx_k_ptcl, sizeof(__pyx_k_ptcl), 0, 0, 1, 1},
 ...
 */
  ...
  __Pyx_GIVEREF(__pyx_slice_);
  __pyx_tuple__2 = PyTuple_Pack(2, __pyx_int_0, __pyx_slice_); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 61, __pyx_L1_error)
...
static int __Pyx_modinit_type_import_code(void) {
  ...
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyImport_ImportModule("emf"); if (unlikely(!__pyx_t_1)) __PYX_ERR(4, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_ptype_3emf_EMF = __Pyx_ImportType(__pyx_t_1, "emf", "EMF", sizeof(struct __pyx_obj_3emf_EMF), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_3emf_EMF) __PYX_ERR(4, 3, __pyx_L1_error)
  __pyx_vtabptr_3emf_EMF = (struct __pyx_vtabstruct_3emf_EMF*)__Pyx_GetVtable(__pyx_ptype_3emf_EMF->tp_dict); if (unlikely(!__pyx_vtabptr_3emf_EMF)) __PYX_ERR(4, 3, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyImport_ImportModule("particle"); if (unlikely(!__pyx_t_1)) __PYX_ERR(5, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_ptype_8particle_Particle = __Pyx_ImportType(__pyx_t_1, "particle", "Particle", sizeof(struct __pyx_obj_8particle_Particle), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_8particle_Particle) __PYX_ERR(5, 4, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
...
static int __Pyx_modinit_function_import_code(void) {
  ...
  __pyx_t_1 = PyImport_ImportModule("maths"); if (!__pyx_t_1) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (__Pyx_ImportFunction(__pyx_t_1, "dot_product", (void (**)(void))&__pyx_f_5maths_dot_product, "double (__Pyx_memviewslice, __Pyx_memviewslice)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "cross_i", (void (**)(void))&__pyx_f_5maths_cross_i, "double (__Pyx_memviewslice, __Pyx_memviewslice, int)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initboris_method(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initboris_method(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_boris_method(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_boris_method(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_boris_method(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'boris_method' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_boris_method(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("boris_method", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_boris_method) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "boris_method")) {
      if (unlikely(PyDict_SetItemString(modules, "boris_method", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init boris_method", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init boris_method");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
